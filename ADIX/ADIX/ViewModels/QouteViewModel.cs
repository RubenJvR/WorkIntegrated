...
namespace ADIX.ViewModels
{
    public class QouteViewModel : INotifyPropertyChanged
    {
        ...
        public QouteViewModel()
        {
            InvoiceItems = new ObservableCollection<InvoiceItem>();
            InvoiceDate = DateTime.Now.ToString("yyyy-MM-dd");
            InvoiceNumber = "Q-" + DateTime.Now.ToString("yyyyMMddHHmmss");
            InvoiceItems.CollectionChanged += (s, e) => CalculateTotals();
            CalculateTotals();
        }

        // Updated constructor to accept overall discount
        public QouteViewModel(System.Collections.Generic.List<POSItem> cartItems, string customerName, string selectedStaff, string vatAmount, string paymentMethod, string customerAddress, decimal overallDiscountPercent)
        {
            InvoiceItems = new ObservableCollection<InvoiceItem>();
        ...
        public class InvoiceItem : INotifyPropertyChanged
        {
            ...
            public string? SKU
            {
                ...
                set
                {
                    ...
                    OnPropertyChanged(nameof(ItemDiscountAmount));
                }
            }
            ...
            // Calculate item discount amount (this is the actual R amount)
            public decimal ItemDiscountAmount => (UnitPrice * Quantity) * Discount;

            // Calculate total after item discount
